<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ThongTinSinhVien.aspx.cs" Inherits="BaiThi_OnTap.ThongTinSinhVien" %>
        ...
        .groupBtn{
            ...
            padding: 3px 5px 3px 5px;
                    ...
                    <div class="title-right">
                        <asp:Label ID="lblTitleRight" runat="server" Text="Cập Nhật Sinh Viên"></asp:Label>
                    </div>
                    <div class="table">
                        <table>
                            <tr>
